...
export default function DraggableAccountCard({
  account,
  index,
  onDelete,
  onUpdate,
  ...
  return (
    <>
      <div
        ...
        className={`bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-5 transition-all hover:shadow-md cursor-grab active:cursor-grabbing ${
